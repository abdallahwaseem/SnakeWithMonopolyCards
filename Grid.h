...
public:
	...
	OfferMortgage* GetOfferMortgage();
	...
	void SetClipboard(CoinSet* c);
	CoinSet* GetcClipboard() const;
	...
	GameObject* GetGameObject(CellPosition a);
	Player* GetPlayerFromPos(CellPosition a);
	///TODO: add any needed setter/getter "EXCEPT" ANY setters or getters of "CellList" or "PlayerList" (Forbidden for class Responsibilities)

	Card* GetHighestPriceCity(Grid* pGrid, Player* pPlayer);
	Card* GetLowestPriceCity(Grid* pGrid, Player* pPlayer);
	void SetOfferedPos(string*p,int a);
	string* GetOfferedPos();
	void SetAllOwnerCairoCard_7(Player* Owner);
	void SetAllSubOwnerCairoCard_7(Player* Owner);
	void SetAllOwnerAlexCard_8(Player* Owner);
	void SetAllSubOwnerAlexCard_8(Player* Owner);
	void SetAllOwnerAswanCard_9(Player* Owner);
	void SetAllSubOwnerAswanCard_9(Player* Owner);
	void SetAllOwnerLuxorCard_10(Player* Owner);
	void SetAllSubOwnerLuxorCard_10(Player* Owner);
	void SetAllOwnerHurghadaCard_11(Player* Owner);
	void SetAllSubOwnerHurghadaCard_11(Player* Owner);
	void SetNumOfOfferedCities(int s);
	int GetNumOfOfferedCities();
	Card* GetFirstCairoCard_7();
	Card* GetFirstAlexCard_8();
	Card* GetFirstAswanCard_9();
	Card* GetFirstLuxorCard_10();
	Card* GetFirstHurghadaCard_11();
	bool PlayerHasCities(Player* pPlayer);
	// ========= Other Getters =========
	...
	void setclipboardcheck(int a);
	int getclipboardcheck();
	...
	Player* WinnerPlayer();
	void PlayerListLoop(Grid* pGrid, Player* pPlayer);
	void PLayerListFreeze(Grid* pGrid, Player* pPlayer, int NumberOfTurnsFreezed, bool Even);
	Player* GetBenefitPlayer();
	void StartNewGame();
	void fire(Player* p, CellPosition newp, int vc, int hc);
	int numberofgameobjects(int a);
