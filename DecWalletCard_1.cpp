...
void DecWalletCard_1::Save(ofstream& OutFile, int a )
{
	if (a == 1)
	{
...
void DecWalletCard_1::Load(ifstream& Infile, int a, CellPosition& s, CellPosition& e, int& amount)
{
...
int DecWalletCard_1::GetWalletAmount()
{
	return walletAmount;
}
void DecWalletCard_1::SetWalletAmount(int amount)
{
	walletAmount = amount;
}