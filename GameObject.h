...
public:
	...
	virtual void Save(ofstream &OutFile,int a)=0;	// Saves the GameObject parameters to the file --> feel free to change this prototype as needed
	virtual void Load(ifstream &Infile,int a,CellPosition&s, CellPosition& e,int&amount)=0;	// Loads and Reads the GameObject parameters from the file --> feel free to change this prototype as needed
	virtual int getsave();
